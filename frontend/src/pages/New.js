        ...
        render()
        {
            return (
                <form id="new-post" onSubmit={this.handleSubmit}>
                    ...
                    <input type="text" placeholder="place" name="place" onChange={this.handleChange} value={this.state.place} />  

                    <input type="text" placeholder="description" name="description" onChange={this.handleChange} value={this.state.description} />  

                    <input type="text" placeholder="hashtags" name="hashtags" onChange={this.handleChange} value={this.state.hashtags}/>  
